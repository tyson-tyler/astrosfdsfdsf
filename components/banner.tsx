  ...
  return (
    <>
      <div className="w-full rounded-lg overflow-hidden flex flex-col mt-14 mb-6">
        <section className="w-full flex-center  flex-col mt-6 mb-[30px] lg:h-[500px] md:h-[400px] sm:h-[250px] h-[250px]  bg-no-repeat bg-contain bg-[url('https://cdn.pixabay.com/photo/2019/10/26/10/39/tarot-4579147_640.jpg')]">
          {/* 
